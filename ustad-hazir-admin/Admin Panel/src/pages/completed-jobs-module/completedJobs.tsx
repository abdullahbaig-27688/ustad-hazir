...
import { getAllCompletedJobs } from "../../services/getallcompletedjobs";
...
export default function CompletedJobs() {
  ...
  return (
    <div className="completed-jobs-container">
      ...
      <main className="completed-jobs-content">
        <header className="completed-jobs-header">
          <h2 className="section-title">📩 Completed Jobs</h2>
        </header>

        {loading && <p>Loading completed jobs...</p>}
