...
import { getAllPendingJobs } from "../../services/getallpendingsjobs";
...
export default function PendingJobs() {
  ...
  return (
    <div className="pending-jobs-container">
      ...
      <main className="pending-jobs-content">
        <header className="pending-jobs-header">
          <h2 className="section-title">🕒 Pending Jobs</h2>
        </header>

        {loading && <p>Loading pending jobs...</p>}

        {!loading && jobs.length === 0 && <p>No pending jobs found.</p>}
          ...
          {jobs.map((job) => (
            <div className="job-card" key={job.id}>
              ...
              <div className="job-info">
                ...
                <p className="status pending">Job Status: {job.status}</p>
              </div>
